...
def main(args):
    ...
    #host = host.decode()
    host1 = host.decode('utf-8')
    print(host1)
    var = host1.split(":")
    value = vars(args)['zkName']
    ...
    #    topic, url = reqister(self,topic, 5556)
    #    url = "tcp://*:" + str(port)

    pub[0].registerapp.register(my_topics, "tcp://*:" + var[1], "publisher")
    #
    ...
    pub[0].publish(my_topics,var[1],value)
